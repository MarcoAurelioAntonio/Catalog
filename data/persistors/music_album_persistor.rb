...
module MusicAlbumPersistor
  ...
  def self.read_from_file
    ...
    deserialized_music_albums.map { |music_album| json_to_ruby(music_album) }
  end
  ...
  def self.json_to_ruby(json)
    ...
    new_music_album.genre = GenrePersistor.json_to_ruby(json['genre'])
  ...
  def self.ruby_to_json(music_album_item)
    {
      ...
      genre: GenrePersistor.ruby_to_json(music_album_item.genre),
